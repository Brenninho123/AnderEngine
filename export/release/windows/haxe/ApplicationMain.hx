...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("AnderEngine", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("AnderEngine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "175";
		app.meta["company"] = "Ander";
		app.meta["file"] = "AnderEngine";
		app.meta["name"] = "Friday Night Funkin': Ander Engine";
		app.meta["packageName"] = "com.funkin.anderengine";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': Ander Engine",
			width: 1280,
			x: null,
			y: null,
		};
		...
		#elseif air
		app.window.title = "Friday Night Funkin': Ander Engine";
		#else
