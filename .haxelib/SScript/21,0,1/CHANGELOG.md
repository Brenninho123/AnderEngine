...
# 20.6.618
- Added EReg support (Check [README.md](https://github.com/ThomasDarkson/SScript?tab=readme-ov-file#regular-expressions))
- Fixed classes
- Importing Tea Classes will now import its fields
- Improved type checker

# 19.0.618
- Added a new improved field system (Check [README.md](https://github.com/ThomasDarkson/SScript?tab=readme-ov-file#improved-field-system))
- Fixed `as` in imports
...
# 17.0.618
- 3LLua (Check [README.md](https://github.com/ThomasDarkson/SScript?tab=readme-ov-file#3LLua))
